  ...
  data() {
    return {
      ...
      columns: [
        ...
        {key: 10, label: "库区编号", visible: true},
        {key: 11, label: "库区名称", visible: true},
        {key: 12, label: "上期结存", visible: true},
        {key: 13, label: "本期入库", visible: true},
        {key: 14, label: "本期出库", visible: true},
        {key: 15, label: "本期盘点", visible: true},
        {key: 16, label: "本期结存", visible: true},
        {key: 18, label: "备注", visible: true},
      ],
      showMoreCondition: true
    };
  },
  created() {
    this.getList();
